...
const generateToken = require('../../utils/ecom/generateToken');
const emailService = require('../../services/ecom/emailService');

/**
 * E-commerce User signup/registration
 */
...
const verifyToken = async (req, res) => {
    ...
    try {
        ...
        const user = await EcomUser.findById(decoded.userId);
